...
big_rat_url = "https://x0.at/e-yb.mp4"
...
class NudesMod(loader.Module):
    ...
    async def Nudescmd(self, message):
        ...
        if not target:
            return await message.edit("<b>Please specify who to give nudes.</b>")

        msg = await utils.answer(message, "<b>Sending nudes...</b>")
        await message.client.send_file(target, big_rat_url)
        await utils.answer(msg, "<b>Sent nudes successfully!</b>")
